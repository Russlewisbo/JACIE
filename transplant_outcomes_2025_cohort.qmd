...
calc_os_timepoint <- function(data, timepoint) {
  ...
  # At risk = those who haven't died or been censored before timepoint
  n_at_risk <- sum(data$days_to_event >= timepoint | 
                   (data$death == 1 & data$days_to_event <= timepoint))
